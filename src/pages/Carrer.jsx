          ...
          <Col>
            ...
            >
              ...
              <CardBody className="m-0 rounded-bottom">
                ...
                <p className="m-0">
                  provides tailored career development resources
                </p>
              </CardBody>
            </Card>
          </Col>
          <Col>
            ...
            >
              ...
              <CardBody className="m-0 rounded-bottom">
                ...
                <p className="m-0">
                  equips individuals with the skills and confidence
                </p>
              </CardBody>
            </Card>
          </Col>
          <Col>
            ...
            >
              ...
              <CardBody className="m-0 rounded-bottom">
                ...
                <p className="m-0">
                  connects talented professionals with opportunities
                </p>
              </CardBody>
            </Card>
          </Col>
          <Col>
            ...
            >
              ...
              <CardBody className="m-0 rounded-bottom">
                ...
                <p className="m-0">cultivates a community where individuals </p>
              </CardBody>
            </Card>
          </Col>
        </Row>
