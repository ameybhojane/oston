          ...
          <Col>
            ...
            >
              ...
              <CardBody className="m-0 rounded-bottom">
                ...
                <p className="m-0">helps you to build carrer in data science</p>
              </CardBody>
            </Card>
          </Col>
          <Col>
            ...
            >
              ...
              <CardBody className="m-0 rounded-bottom">
                ...
                <p className="m-0">helps folk break into data</p>
              </CardBody>
            </Card>
          </Col>
          <Col>
            ...
            >
              ...
              <CardBody className="m-0 rounded-bottom">
                ...
                <p className="m-0">global data leader in energy industry</p>
              </CardBody>
            </Card>
          </Col>
          <Col>
            ...
            >
              ...
              <CardBody className="m-0 rounded-bottom">
                ...
                <p className="m-0">
                  helps people accelerate carrer in data science
                </p>
              </CardBody>
            </Card>
          </Col>
